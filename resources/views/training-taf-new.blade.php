...
<div class="card">
  <div class="card-body">
    <h5 class="card-title">Input Training Application Form (TAF)</h5>
<form id="newTr" autocomplete="off" enctype="multipart/form-data">
    @csrf
    <div class="row mb-3">
      <label class="col-md-4 col-lg-3 col-form-label">Create Date</label>
      <div class="col-md-8 col-lg-9">
        <input name="createDate" type="date" class="form-control" id="createDate" value="{{date("Y-m-d")}}">
        <div class="invalid-feedback"></div>
      </div>
    </div>
    <div class="row mb-3">
      <label class="col-md-4 col-lg-3 col-form-label">To</label>
      <div class="col-md-8 col-lg-9">
        <input name="to" type="text" class="form-control" id="to" value="People Development Division">
        <div class="invalid-feedback"></div>
      </div>
    </div>
    <div class="row mb-3">
      <label class="col-md-4 col-lg-3 col-form-label">From</label>
      <div class="col-md-8 col-lg-9">
        <input name="from" type="text" class="form-control" id="from" value="PPD MACO">
        <div class="invalid-feedback"></div>
      </div>
    </div>
    <div class="row mb-3">
      <label class="col-md-4 col-lg-3 col-form-label">Subject</label>
      <div class="col-md-8 col-lg-9">
        <input name="subject" type="text" class="form-control" id="subject" value="Pengajuan Pelatihan Kerja">
        <div class="invalid-feedback"></div>
      </div>
    </div>
    <div class="row mb-3">
      <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Jenis TAF</label>
      <div class="col-md-8 col-lg-9">
  ...
  <div class="row mb-3">
    ...
    <div class="col-md-8 col-lg-9">
      <input name="biaya" type="number" class="form-control" id="biaya" placeholder="kosongi jika gratis">
      <div class="invalid-feedback"></div>
     </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-md-8 col-lg-9">
      <input name="diajukan" type="text" class="form-control" id="diajukan" value="Didit Pramudya">
      <div class="invalid-feedback"></div>
     </div>
  </div>
  <div class="row mb-3">
    ...
    <div class="col-md-8 col-lg-9">
      <input name="disetujui" type="text" class="form-control" id="disetujui" value="">
      <div class="invalid-feedback"></div>
     </div>
  </div>
  <div class="row mb-3">
    ...
    <div class="col-md-8 col-lg-9">
      <input name="diperiksa" type="text" class="form-control" id="diperiksa" value="">
      <div class="invalid-feedback"></div>
     </div>
  </div>
  <div class="row mb-3">
    ...
    <div class="col-md-8 col-lg-9">
      <input name="divHead" type="text" class="form-control" id="divHead" value="">
      <div class="invalid-feedback"></div>
     </div>
  </div>
