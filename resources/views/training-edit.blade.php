...
<form id="editTr" autocomplete="off" enctype="multipart/form-data">
    @csrf
    <input name='idTrOld' type="hidden" value="{{ $idTr->imore }}">
  <div class="row mb-3">
    ...
    <div class="col-md-8 col-lg-9">
      <select name="kodeTraining" id="kodeTraining" class="form-select" autofocus>
        ...
        @if ($dataTraining->first()->kodeTr===$data->kode)
  ...
  <div class="row mb-3">
    ...
    <div class="col-md-8 col-lg-9">
      <select name="uraianMateri" id="uraianMateri" class="form-select">
        ...
        @if ($dataTraining->first()->kodeUraianMateri===$data->id)
  ...
  <div class="row mb-3">
    ...
    <div class="col-md-8 col-lg-9">
      <select name="lokasi" id="lokasi" class="form-select">
        ...
        @if ($dataTraining->first()->lokasi===$data->id)
  ...
  <div class="row mb-3">
    ...
    <div class="col-md-8 col-lg-9">
      <select name="lembaga" id="lembaga" class="form-select">
        ...
        @if ($dataTraining->first()->kodeLembaga===$data->id)
  ...
  <div class="row mb-3">
    ...
    <div class="col-md-8 col-lg-9">
      <select name="instructor" id="instructor" class="form-select">
        ...
        @if ($dataTraining->first()->instructor===$data->id)
        <option value="{{ $data->id }}" selected>{{ $data->namaInstructor }}</option>
        @else
  ...
  <div class="row mb-3">
    ...
    <div class="col-md-8 col-lg-9">
      <input name="startDate" type="date" class="form-control" id="startDate" value="{{ $dataTraining->first()->start }}">
      <div class="invalid-feedback"></div>
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-md-8 col-lg-9">
      <input name="endDate" type="date" class="form-control" id="endDate" value="{{ $dataTraining->first()->end }}">
      <div class="invalid-feedback"></div>
    </div>
  </div>
  ...
  <div class="row mb-3">
    ...
    <div class="col-md-8 col-lg-9">
      <select name="category" class="form-select" id="category" value="">
        ...
        @if ($dataTraining->first()->category===$data)
  ...
  <div class="row mb-3">
    ...
    <div class="col-md-8 col-lg-9">
      <select name="programTraining" class="form-select" id="programTraining">
        @forEach($programTraining as $data)
        @if ($dataTraining->first()->programTraining===$data)
        <option selected>{{ $data }}</option>
        @else 
        <option>{{ $data }}</option>
        @endif
  ...
  <div class="row mb-3">
    ...
    <div class="col-md-8 col-lg-9">
      <select name="hardSoft" class="form-select" id="hardSoft" >
        @foreach($hardSoft as $data)
        @if ($dataTraining->first()->hardSoft===$data)
        <option selected>{{ $data }}</option>            
        @else
            <option>{{ $data }}</option>
        @endif
  ...
  <div class="row mb-3">
    ...
    <div class="col-md-8 col-lg-9">
      <textarea name="remark" type="text" class="form-control" id="remark">{{ $dataTraining->first()->trainingRemark }}</textarea>
    </div>
  </div>
  ...
  <div class="row mb-3">
    <div class="iconslist">
      <div class="icon">
        ...
        <button id="deleteFileAbsensi" type="button" class="btn bi bi-trash"></button>
        @else
        <i class="bi bi-file-earmark-x" title="No File Guys"></i>
        <div class="label">Absensi</div>
        @endif 
        <button id="uploadAbsensi" type="button" class="btn bi bi-upload" title="Click To Upload"></button>
        </div>
        <input type="file" class="form-control" name="fileAbsensi" id="fileAbsensi" hidden>
      </div>
      <div class="icon">
        <div id="fileDocumenIcon">
        @if ($dokumenCek)
        <i class="bi bi-file-earmark-pdf"></i>
        <div class="label">Document</div>
        <button id="deleteFileDokumen" type="button" class="btn bi bi-trash"></button>
        @else 
        <i class="bi bi-file-earmark-x" title="No File Guys"></i>
        <div class="label">Document</div>
        @endif
        <button id="UploadDokumen" type="button" class="btn bi bi-upload" title="Click To Upload"></button>
        </div>
        <input type="file" class="form-control" name="fileDokumenTraining" id="fileDokumenTraining" hidden>
      </div>
    </div>
  </div>
        ...
        <div class="modal-body">
          <form id="dataParticipant">
            ...
            <select name="namaParticipant" id="namaParticipant" class="form-select">
              ...
              <option value="{{ $data->nrp."||".$data->nama."||".$data->perusahaan."||".$data->jabatanFn }}">{{ $data->nrp."||".$data->nama."||".$data->perusahaanText."||".$data->jabatanFn }}</option>
              @endforeach
            </select>
            </div>
            <div class="mb-3">
...
$(document).ready(function(){
  ...
  $(document).on('click',"#submitParticipant",function(){
    ...
    let dataIn={
      ...
      perusahaan:y[2],
      jabatanFn:y[3],
      pre:formData.get('preTest'),
      post:formData.get('postTest'),
  ...
  $(document).on('submit','#editTr',function(e){
    ...
    formData.append('fileStatus',JSON.stringify(fileData));
